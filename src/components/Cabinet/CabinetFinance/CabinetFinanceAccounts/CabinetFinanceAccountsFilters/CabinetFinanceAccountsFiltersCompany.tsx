...
const CabinetFinanceAccountsFiltersCompany: React.FC = () => {
    return (
        <div className="cabinet-block-finance-accounts-filters-selects-item">
...
export default CabinetFinanceAccountsFiltersCompany;
