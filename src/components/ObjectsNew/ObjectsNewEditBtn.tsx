...
interface ObjectsNewEditBtnProps {
    hash: string;
}

const ObjectsNewEditBtn: React.FC<ObjectsNewEditBtnProps> = ({hash}) => {
    return (
        <Link to={`#${hash}`} className="objects-new-filled-section-text__edit">
            <svg
                width="22"
                height="22"
                viewBox="0 0 22 22"
...
export default ObjectsNewEditBtn;
